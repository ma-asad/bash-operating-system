...
while true; do
    ...
    choice=$(yad --list --text "Select a system info option" --radiolist --column "Pick" --column "Options" FALSE "Operating System Type" FALSE "CPU Info" FALSE "Memory Info" FALSE "Hard Disk Info" FALSE "File System Info" FALSE "Exit" --separator="" --width=500 --height=300 --fontname="Sans 14" --center --print-column=2)
    ...
    case $choice in
        "Operating System Type")
            ...
            os=$(uname -o)
            yad --info --text "Operating System: $os" --width=500 --height=100 --fontname="Sans 14" --center
            ;;
        "CPU Info")
        ...
        "Memory Info")
            ...
            mem_info=$(free -h)
            yad --info --text "Memory Information: $mem_info" --width=500 --height=200 --fontname="Sans 14" --center
            ;;
        "Hard Disk Info")
            # "df -h" command to get hard disk information.
            disk_info=$(df -h)
            yad --info --text "Hard Disk Information: $disk_info" --width=500 --height=200 --fontname="Sans 14" --center
            ;;
        "File System Info")
